...
void main() {
  ...
  test(
    'five implemented core families remain five independent votes',
    () async {
      ...
      final results = [
        ...
        const InvestorCapitalAllocationEvidenceProvider()
            .evaluate(input)
            .evidence,
        const InvestorValuationEvidenceProvider().evaluate(input).evidence,
      ];
      ...
      expect(consensus.independentFamilyCount, 5);
    },
  );

  test('Batch 4 still cannot activate Investor recommendations', () {
    expect(
