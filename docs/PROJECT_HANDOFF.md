...
**Version:** 1.2
**Checkpoint:** v0.12.0 — Investor Strategy Brain Batch 6 Global Market & Macro Context + Stock Sensitivity Profile Validated
**Date:** 2026-08-31
...
* Investor production recommendation generation is still unavailable; v0.12.0 Batch 6 Global Market & Macro Context + Stock Sensitivity Profile is implemented and validated. Market/macro remains contextual-only, VIX remains non-directional, and Competitive Durability remains overlap-gated from breadth pending Batch 8.
